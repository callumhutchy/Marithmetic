...
public class References : MonoBehaviour {
	...
	public static string HIGHEST_NUMBER_SOLVED, LOWEST_NUMBER_SOLVED, TOTAL_NUMBERS_SOLVED, NUMBER_OF_RESETS, BIG_NUMBERS_USED, SMALL_NUMBERS_USED, HOW_MANY_BIG; 
