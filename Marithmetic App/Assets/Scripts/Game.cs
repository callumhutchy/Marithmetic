...
public class Game : MonoBehaviour {
	...
	void Start () {
		...
		numberButtons = new List<NumberButton> () {
			new NumberButton (button1, button1.GetComponentInChildren<TMP_Text> (), button1Disabled, button1Disabled.GetComponentInChildren<TMP_Text> (), button1Grey),
				new NumberButton (button2, button2.GetComponentInChildren<TMP_Text> (), button2Disabled, button2Disabled.GetComponentInChildren<TMP_Text> (), button2Grey),
				new NumberButton (button3, button3.GetComponentInChildren<TMP_Text> (), button3Disabled, button3Disabled.GetComponentInChildren<TMP_Text> (), button3Grey),
				new NumberButton (button4, button4.GetComponentInChildren<TMP_Text> (), button4Disabled, button4Disabled.GetComponentInChildren<TMP_Text> (), button4Grey),
				new NumberButton (button5, button5.GetComponentInChildren<TMP_Text> (), button5Disabled, button5Disabled.GetComponentInChildren<TMP_Text> (), button5Grey),
				new NumberButton (button6, button6.GetComponentInChildren<TMP_Text> (), button6Disabled, button6Disabled.GetComponentInChildren<TMP_Text> (), button6Grey),
		};
		foreach (NumberButton nb in numberButtons) {
			nb.number.GetComponent<Button> ().onClick.AddListener (delegate { OnNumberButtonClick (nb); });
			nb.numberDisabled.GetComponent<Button> ().onClick.AddListener (delegate { OnNumberButtonDisabledClick (nb); });
		}
		operationButtons = new List<OperationButton> () {
			new OperationButton (addButton, addButton.GetComponent<Button> (), addButtonDisabled, addButtonDisabled.GetComponent<Button> (), Operation.ADDITION),
				new OperationButton (subtractButton, subtractButton.GetComponent<Button> (), subtractButtonDisabled, subtractButtonDisabled.GetComponent<Button> (), Operation.SUBTRACT),
				new OperationButton (multiplyButton, multiplyButton.GetComponent<Button> (), multiplyButtonDisabled, multiplyButtonDisabled.GetComponent<Button> (), Operation.MULTIPLY),
				new OperationButton (divideButton, divideButton.GetComponent<Button> (), divideButtonDisabled, divideButtonDisabled.GetComponent<Button> (), Operation.DIVISION)
		};
	...
	public void ResetButtons () {
		for (int i = 0; i < numberButtons.Count; i++) {
			...
			nb.number.SetActive (true);
			nb.number.GetComponent<Button> ().enabled = true;
			nb.numberDisabled.SetActive (false);
			nb.numberGrey.SetActive (false);
		}
		foreach (OperationButton ob in operationButtons) {
	...
	public void OnNumberButtonClick (NumberButton nb) {
		if (!number1selected && !operationselected && !number2selected) {
			...
			nb.numberDisabled.SetActive (true);
			number1selected = true;
			tempButton1 = nb.number;
			tempButton1Disabled = nb.numberDisabled;
			...
			tempButton2 = nb.number;
			tempButton2Disabled = nb.numberDisabled;
			tempButton2Grey = nb.numberGrey;
	...
	public void OnOperationButtonClick (OperationButton ob) {
		if (number1selected && !operationselected && !number2selected) {
			...
			tempOperationButtonDisabled = ob.disabledGameObject;
...
public class OperationButton {
	...
	public OperationButton (GameObject gameObject, Button button, GameObject disabledGameObject, Button disabledButton, Operation operation) {
...
public class NumberButton {
	...
	public GameObject numberDisabled;
	public TMP_Text numberDisabledText;
	public GameObject numberGrey;

	public NumberButton (GameObject number, TMP_Text numberText, GameObject numberDisabled, TMP_Text numberDisabledText, GameObject numberGrey) {
		this.number = number;
		this.numberText = numberText;
		this.numberDisabled = numberDisabled;
		this.numberDisabledText = numberDisabledText;
		this.numberGrey = numberGrey;
